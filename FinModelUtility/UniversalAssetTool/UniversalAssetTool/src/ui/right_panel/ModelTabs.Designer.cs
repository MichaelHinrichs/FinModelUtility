namespace uni.ui.right_panel {
  partial class ModelTabs {
    ...
    private void InitializeComponent() {
      ...
      this.skeletonTab_ = new uni.ui.right_panel.skeleton.SkeletonTab();
      ...
      this.infoTab_ = new uni.ui.right_panel.info.InfoTab();
      this.registersTab_ = new uni.ui.right_panel.registers.RegistersTab();
