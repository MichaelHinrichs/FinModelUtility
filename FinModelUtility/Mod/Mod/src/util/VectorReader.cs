...
namespace mod.util {
  public class VectorReader {
    ...
    public VectorReader(Endianness endianness = Endianness.LittleEndian) {
    ...
    public ushort ReadU16() {
      ...
      return (ushort) ((this.endianness_ == Endianness.LittleEndian)
          ? (byte0 | (byte1 << 8))
          : (byte1 | (byte0 << 8)));
    }
    ...
    public uint ReadU32() {
      ...
      return (uint) ((this.endianness_ == Endianness.LittleEndian)
    ...
    public ulong ReadU64() {
      ...
      return (this.endianness_ == Endianness.LittleEndian)
    ...
    public short ReadS16() {
      ...
      return (short) ((this.endianness_ == Endianness.LittleEndian)
          ? (byte0 | (byte1 << 8))
          : (byte1 | (byte0 << 8)));
    }
