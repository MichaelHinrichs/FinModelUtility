...
void main() {
  ...
  vec3 colorComponent = (vec3(0.250980406999588)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*vec3(0.0313725508749485) + mergedLightSpecularColor.rgb;
