...
void main() {
  ...
  vec3 colorComponent = (vec3(0.250980406999588)*ambientLightColor.rgb + individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + individualLightDiffuseColors[3].rgb + individualLightDiffuseColors[4].rgb + individualLightDiffuseColors[5].rgb + individualLightDiffuseColors[6].rgb + individualLightDiffuseColors[7].rgb)*vec3(2)*vec3(0.0313725508749485)*vertexColor0.rgb + individualLightSpecularColors[0].rgb + individualLightSpecularColors[1].rgb + individualLightSpecularColors[2].rgb + individualLightSpecularColors[3].rgb + individualLightSpecularColors[4].rgb + individualLightSpecularColors[5].rgb + individualLightSpecularColors[6].rgb + individualLightSpecularColors[7].rgb;
