...
void main() {
  ...
  vec3 colorComponent = (vec3(0.09803921729326248)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2) + vec3(0.7647058963775635,0.800000011920929,0.800000011920929)*mergedLightSpecularColor.rgb;
