...
void main() {
  ...
  vec3 colorComponent = (vec3(0.6235294342041016,0.26274511218070984,0.13333334028720856)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2) + mergedLightSpecularColor.rgb;
