...
void main() {
  ...
  vec3 colorComponent = (vec3(0.7019608020782471,0.7019608020782471,0)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2) + vec3(1,0.800000011920929,0)*mergedLightSpecularColor.rgb;
