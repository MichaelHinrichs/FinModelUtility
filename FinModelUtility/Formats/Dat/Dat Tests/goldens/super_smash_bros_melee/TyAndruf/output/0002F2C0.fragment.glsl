...
void main() {
  ...
  vec3 colorComponent = (vec3(0.9529411792755127,0.8509804010391235,0)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2) + vec3(1,1,0.5490196347236633)*mergedLightSpecularColor.rgb;
