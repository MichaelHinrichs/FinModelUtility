...
void main() {
  ...
  vec3 colorComponent = texture(texture0.sampler, clamp(asin(transformUv3d(texture0.transform3d, normalUv)) / 3.14159 + 0.5, texture0.clampMin, texture0.clampMax)).rgb*(vec3(0.501960813999176) + individualLightColors[0].rgb*vec3(0.7019608020782471));
