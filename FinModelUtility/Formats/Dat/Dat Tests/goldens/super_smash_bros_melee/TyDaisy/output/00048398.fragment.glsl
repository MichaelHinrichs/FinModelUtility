...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999176)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*texture(texture0, uv0).rgb + mergedLightSpecularColor.rgb;
