...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999176)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*texture(texture0, uv0).rgb + vec3(0.7019608020782471)*mergedLightSpecularColor.rgb;
