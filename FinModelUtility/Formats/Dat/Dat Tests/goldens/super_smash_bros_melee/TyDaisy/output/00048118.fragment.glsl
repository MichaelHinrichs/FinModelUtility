...
void main() {
  ...
  vec3 colorComponent = texture(texture0.sampler, clamp(transformUv3d(texture0.transform3d, uv0), texture0.clampMin, texture0.clampMax)).rgb*(vec3(0.5960784554481506,0.5333333611488342,0.5058823823928833) + individualLightColors[0].rgb*vec3(0.7019608020782471));
