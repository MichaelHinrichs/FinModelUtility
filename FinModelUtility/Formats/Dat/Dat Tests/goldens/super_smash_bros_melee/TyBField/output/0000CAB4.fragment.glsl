...
void main() {
  vec3 colorComponent = vec3(1,0.7529411911964417,0)*texture(texture0.sampler, clamp(transformUv3d(texture0.transform3d, uv0), texture0.clampMin, texture0.clampMax)).rgb;
