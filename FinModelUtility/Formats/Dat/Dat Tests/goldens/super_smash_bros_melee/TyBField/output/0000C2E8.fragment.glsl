...
void main() {
  ...
  vec3 colorComponent = texture(texture0.sampler, clamp(transformUv3d(texture0.transform3d, uv0), texture0.clampMin, texture0.clampMax)).rgb*(vec3(0.20000000298023224) + individualLightColors[0].rgb);
