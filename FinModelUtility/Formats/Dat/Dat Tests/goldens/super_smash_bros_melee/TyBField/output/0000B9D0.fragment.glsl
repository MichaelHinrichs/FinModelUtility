...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999176)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*vec3(1,0.7019608020782471,0) + mergedLightSpecularColor.rgb;
