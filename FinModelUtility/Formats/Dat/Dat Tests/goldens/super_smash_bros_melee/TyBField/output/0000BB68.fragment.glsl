...
void main() {
  ...
  vec3 colorComponent = (vec3(0.501960813999176)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*vec3(1,0.5490196347236633,0) + mergedLightSpecularColor.rgb;
