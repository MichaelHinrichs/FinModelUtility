...
void main() {
  ...
  vec3 colorComponent = (vec3(0.20000000298023224)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2)*texture(texture0, uv0).rgb + mergedLightSpecularColor.rgb;
