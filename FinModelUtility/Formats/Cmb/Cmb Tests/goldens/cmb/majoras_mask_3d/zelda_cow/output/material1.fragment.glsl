...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.4000000059604645) + (individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + individualLightDiffuseColors[2].rgb + individualLightDiffuseColors[3].rgb + individualLightDiffuseColors[4].rgb + individualLightDiffuseColors[5].rgb + individualLightDiffuseColors[6].rgb + individualLightDiffuseColors[7].rgb)*vec3(0.49803921580314636))*texture(texture0, uv0).rgb*vec3(2)*vec3(0.49803921580314636);
