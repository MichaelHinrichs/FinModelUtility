...
void main() {
  ...
  vec3 colorComponent = texture(texture0, uv0).rgb*(ambientLightColor.rgb*vec3(0.800000011920929) + mergedLightDiffuseColor.rgb) + (ambientLightColor.rgb*vec3(0.800000011920929) + mergedLightDiffuseColor.rgb)*texture(texture0, uv0).rgb;
