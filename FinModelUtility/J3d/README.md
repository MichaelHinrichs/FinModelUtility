...
Library for extracting models from the various J3D formats (.bmd/.bdl models and various animation/texture formats), which were used in various GameCube/Wii games:
