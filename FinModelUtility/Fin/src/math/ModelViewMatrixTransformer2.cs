...
namespace fin.math {
  public class SoftwareModelViewMatrixTransformer2 {
    ...
    public SoftwareModelViewMatrixTransformer2() {
      this.Push();
    ...
    public void ProjectVertex(
      ...
      => GlMatrixUtil2.Project(this.current_,
                              ref x,
                              ref y,
                              ref z,
                              1,
    ...
    public SoftwareModelViewMatrixTransformer2 Push() {
    ...
    public SoftwareModelViewMatrixTransformer2 Pop() {
    ...
    public SoftwareModelViewMatrixTransformer2 Identity() {
      this.current_.Clear();
      for (var i = 0; i < 4; ++i) {
        this.current_[i, i] = 1;
      }
    ...
    public SoftwareModelViewMatrixTransformer2 Translate(
        double x,
        double y,
        double z) {
    ...
    public SoftwareModelViewMatrixTransformer2 RotateAroundAxis(
        double angle,
        double x,
        double y,
        double z) {
    ...
    public SoftwareModelViewMatrixTransformer2 Rotate(Quaternion q)
      => this.Rotate(q.X, q.Y, q.Z, q.W);

    public SoftwareModelViewMatrixTransformer2 Rotate(
        float qx,
        float qy,
        float qz,
        float qw) {
    ...
    public SoftwareModelViewMatrixTransformer2 Scale(
        double x,
        double y,
        double z) {
      this.rhsBuffer_.Clear();
    ...
    public SoftwareModelViewMatrixTransformer2 MultMatrix(Matrix<double> m) {
