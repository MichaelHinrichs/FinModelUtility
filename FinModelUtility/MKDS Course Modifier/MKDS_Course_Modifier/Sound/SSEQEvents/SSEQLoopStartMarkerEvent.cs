...
// Type: MKDS_Course_Modifier.Sound.SSEQEvents.SSEQLoopStartMarkerEvent
...
namespace MKDS_Course_Modifier.Sound.SSEQEvents
{
  public class SSEQLoopStartMarkerEvent : SSEQEvent
  {
    ...
    {
      return LanguageHandler.GetString("sound.sseq.events.loopstartmarker");
    }
  }
}
